...
class FormsDataTable extends DataTable
{
   ...
   public function dataTable(DataTables $dataTables, $query)
   {
      return datatables($query)
         ->addColumn('actions', 'admin.forms.buttons.actions')
         ->addColumn('form', 'admin.forms.buttons.form')
         ...
         ->rawColumns(['checkbox', 'show_action', 'actions', 'form', 'user', 'date']);
   }
   ...
   {
      return Forms::query()->orderBy('id', 'desc');
   ...
   protected function getColumns()
   {
      return [
         ...
         [
            'name'  => 'form_name',
            'data'  => 'form_name',
            'title' => trans('admin.form_name'),
         ],
         [
            'name'  => 'form',
            'data'  => 'form',
            'title' => trans('admin.form'),
         ],
         [
            'name'       => 'actions',
            'data'       => 'actions',
