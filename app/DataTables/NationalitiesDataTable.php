...
class NationalitiesDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.nationalities.buttons.actions')
    ...
    {
        return Nationalities::query()->orderBy('id','desc');
