...
class PatientsDataTable extends DataTable
{
   ...
   public function dataTable(DataTables $dataTables, $query)
   {
      return datatables($query)
         ->addColumn('actions', 'admin.patients.buttons.actions')
         ->addColumn('nationality', function ($q){
             $national = \DB::table('nationalities')->where('id', $q->nationality)->first();
             if($national) return $national->nat_name ; else return  "لم يحدد";
         })
          ->addColumn('last_update_user', function ($q){
             return $q->last_update_user->name ?? "لم يحدد";
         })
   ...
   {
      return Patient::query()->with('last_update_at')->orderBy('id', 'desc')->select('patients.*');
   ...
   protected function getColumns()
   {
      return [
         ...
         [
            'name'  => 'civil',
            'data'  => 'civil',
            'title' => trans('admin.civil'),
         ],

         [
            'name'  => 'last_update_user',
            'data'  => 'last_update_user',
            'title' => trans('admin.last_update_at'),
         ],
