...
class DiagnosisDataTable extends DataTable
{
   ...
   public function dataTable(DataTables $dataTables, $query)
   {
      return datatables($query)
         ->addColumn('actions', 'style.diagnosis.buttons.actions')
         ->addColumn('period', 'style.diagnosis.buttons.period')
   ...
   {
      return Diagnos::query()
         ->with('dr_id')
         ->with('patient_id')
         ->orderBy('id', 'desc')->select('diagnos.*');
      ...
      //->ajax('')
         ->parameters([
            ...
            'buttons'      => [
               ...
               canDo(auth()->id(),'diagnosis','delete')?
               [
