...
class Expense_subDataTable extends DataTable
{

   public function dataTable(DataTables $dataTables, $query)
   {
      return datatables($query)
         ->addColumn('actions', 'style.expense_sub.buttons.actions')
   ...
   {
      return Expense_sub::query()
          ->with('exp_m_id')
         ->orderBy('id', 'desc')->select('expense_type.*');
   ...
   protected function getColumns()
   {
       return [
         ...
         [
            'name'  => 'id',
            'data'  => 'id',
            'title' => trans('admin.expense_sub_id'),
         ],
           [
               'name'  => 'exp_m_id.exp_m_name',
               'data'  => 'exp_m_id.exp_m_name',
               'title' => trans('admin.exp_m_name'),
           ],
         [
            'name'  => 'exp_name',
            'data'  => 'exp_name',
            'title' => trans('admin.expense_sub_name'),
         ],
