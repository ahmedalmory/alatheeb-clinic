...
class TasdeedDataTable extends DataTable
{
   ...
   public function dataTable(DataTables $dataTables, $query)
   {
      return datatables($query)
         ->addColumn('actions', 'style.tasdeed.buttons.actions')
          ->addColumn('invoice_status', 'style.tasdeed.buttons.invoice_status')
      ...
      return [
         [
          ...
          [
              'name'      => 'in_day',
              'data'      => 'in_day',
              'title'     => trans('admin.appoint_date'),
              'orderable' => false,
          ],
         [
          ...
          [
              'name'      => 'patient_id.civil',
              'data'      => 'patient_id.civil',
