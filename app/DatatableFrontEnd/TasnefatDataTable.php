...
class TasnefatDataTable extends DataTable
{

   public function dataTable(DataTables $dataTables, $query)
   {
      return datatables($query)
         ->addColumn('actions', 'style.tasnefat.buttons.actions')
   ...
   {
      return Tasnefat::query()
         ->orderBy('id', 'desc')->select('category.*');
      ...
      //->ajax('')
         ->parameters([
            ...
            'buttons'      => [
               ...
               canDo(auth()->id(),'categories','delete')?[
                  'text'      => '<i class="fa fa-trash"></i> ' . trans('admin.delete'),
                  'className' => 'btn red btn-outline deleteBtn',
               ]:[], canDo(auth()->id(),'categories','create') ? [
