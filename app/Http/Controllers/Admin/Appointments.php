...
class Appointments extends Controller
{
   ...
   {
      return $appointments->render('admin.appointments.index', ['title' => trans('admin.appointments')]);
   }
   ...
   {
      return view('admin.appointments.create', ['title' => trans('admin.create')]);
   }
   ...
   {
      $appointments = Appoint::find($id);
      return view('admin.appointments.edit', ['title' => trans('admin.edit'), 'appointments' => $appointments]);
   }
   ...
   public function get_period()
   {
      if (request()->has('period') and request()->has('day')) {
         ...
         if (!empty($period) and $period > 0) {
            ...
            return view('admin.appointments.in_time_list', [
               'period'   => $period,
               'select'   => $select,
