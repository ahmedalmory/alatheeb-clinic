...
use App\DatatableFrontEnd\DiagnosisDataTable;
...
class Diagnosis extends Controller
{
   ...
   {
      return $diagnosis->render('style.diagnosis.index', ['title' => trans('admin.diagnosis')]);
   }
   ...
   {
      return view('style.diagnosis.create', ['title' => trans('admin.create')]);
   }
   ...
   public function show($id)
   {
      ...
      return view('style.diagnosis.show', ['title' => trans('admin.show'), 'diagnosis' => $diagnosis]);
   }
   ...
   {
      $diagnosis = Diagnos::find($id);
      return view('style.diagnosis.edit', ['title' => trans('admin.edit'), 'diagnosis' => $diagnosis]);
   }
   ...
   public function get_period()
   {
      if (request()->has('period') and request()->has('day')) {
         ...
         $select      = request('select');
         return view('style.diagnosis.in_time_list', [
            'day'         => request('day'),
