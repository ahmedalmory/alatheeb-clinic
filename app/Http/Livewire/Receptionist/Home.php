...
class Home extends Component
{
    public function render()
    {
        ...
        return view('livewire.receptionist.home', compact('total_patient', 'total_patient_today', 'total_user', 'total_doctor', 'total_departments'))->extends('layouts.app')->section('content');
    }
}
