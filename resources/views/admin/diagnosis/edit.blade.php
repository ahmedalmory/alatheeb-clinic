		...
		<div class="widget-extra body-req portlet light bordered">
			...
			<div class="portlet-body form">
				<div class="col-md-12">
					...
					{!! Form::open(['url'=>aurl('/diagnosis/'.$diagnosis->id),'method'=>'put','id'=>'diagnosis','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							{!! Form::select('group_id',App\Models\Group::pluck('group_name','id'),$diagnosis->group_id,['class'=>'form-control group_id','placeholder'=>trans('admin.group_id')]) !!}
						</div>
					</div>
					<br>
					<div class="form-group ">
