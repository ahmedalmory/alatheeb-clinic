						...
						<div class="portlet-title">
								...
								<div class="actions">
										<a class="btn btn-circle btn-icon-only btn-default" href="{{aurl('forms/create')}}"
												data-toggle="tooltip" title="{{trans('admin.add')}}  {{trans('admin.forms')}}">
												...
												<div class="modal-dialog">
														<div class="modal-content">
																...
																<div class="modal-body">
																		<i class="fa fa-exclamation-triangle"></i>   {{trans('admin.ask_del')}} {{trans('admin.id')}} ({{$forms->id}}) ؟
																</div>
...
{!! Form::open(['url'=>aurl('/forms/'.$forms->id),'method'=>'put','id'=>'forms','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
<div class="form-group">
    {!! Form::label('form_name',trans('admin.form_name'),['class'=>'col-md-3 control-label']) !!}
    <div class="col-md-9">
        {!! Form::text('form_name', $forms->form_name ,['class'=>'form-control','placeholder'=>trans('admin.form_name')]) !!}
    </div>
</div>
<br>
<div class="form-group">
    ...
    <div class="col-md-9">
        ...
        @if(!empty($forms->form))
        <img src="{{it()->url($forms->form)}}" style="width:150px;height:150px;" />
        @endif
    </div>
</div>
<br>
