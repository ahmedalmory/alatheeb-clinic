              ...
              <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{aurl('groups/create')}}"
                           data-toggle="tooltip" title="{{trans('admin.groups')}}">
                        ...
                        <a data-toggle="modal" data-target="#myModal{{$groups->id}}" class="btn btn-circle btn-icon-only btn-default" href="">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                                {{trans('admin.ask_del')}} {{trans('admin.id')}} {{$groups->id}} ؟
...
<b>{{trans('admin.admin_id')}} :</b>
 {{ App\Admin::find($groups->admin_id)->name }}
</div>
