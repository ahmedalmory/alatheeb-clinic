		...
		<div class="widget-extra body-req portlet light bordered">
            ...
            ->selectRaw('CONCAT("' . trans('admin.name') . ': ",first_name,"  ",father_name,"  ",grand_name,"  - ' . trans('admin.civil') . ': ",civil)  as text')
					...
					<div class="form-group col-md-6">
						...
						<div class="col-md-9">
							{!! Form::select('dr_group_id',App\Model\Group::pluck('group_name','id'),old('dr_group_id'),['class'=>'form-control dr_group_id','placeholder'=>trans('admin.dr_group_id')]) !!}
						</div>
					</div>
					...
					<div class="form-group col-md-6">
						...
						<div class="col-md-9">
							{!! Form::select('accountant_group_id',App\Model\Group::pluck('group_name','id'),old('accountant_group_id'),['class'=>'form-control accountant_group_id','placeholder'=>trans('admin.accountant_group_id')]) !!}
						</div>
					</div>
					<div class="form-group col-md-6">
