			...
			<div class="portlet-body form">
				<div class="col-md-12">
					...
					<div class="form-group col-md-3">
						...
						<div class="">
							{!! Form::select('relation_id',App\Model\Relationship::pluck('re_name','id'),old('relation_id'),['class'=>'form-control','placeholder'=>trans('admin.relation_id')]) !!}
						</div>
					</div>
					...
					<div class="form-group col-md-3">
						...
						<div class="">
							{!! Form::select('nationality',App\Model\Nationalities::pluck('nat_name','id'),old('nationality'),['class'=>'form-control','placeholder'=>trans('admin.nationality')]) !!}
						</div>
					</div>
					<div class="clearfix"></div>
