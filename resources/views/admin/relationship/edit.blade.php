	...
	<div class="col-md-12">
		<div class="widget-extra body-req portlet light bordered">
			<div class="portlet-title">
				...
				<div class="actions">
					<a class="btn btn-circle btn-icon-only btn-default" href="{{aurl('relationship/create')}}"
						data-toggle="tooltip" title="{{trans('admin.add')}}  {{trans('admin.relationship')}}">
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body">
									<i class="fa fa-exclamation-triangle"></i>   {{trans('admin.ask_del')}} {{trans('admin.id')}} ({{$relationship->id}}) ؟
								</div>
			...
			<div class="portlet-body form">
				<div class="col-md-12">
					{!! Form::open(['url'=>aurl('/relationship/'.$relationship->id),'method'=>'put','id'=>'relationship','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
					<div class="form-group">
						{!! Form::label('re_name',trans('admin.re_name'),['class'=>'col-md-3 control-label']) !!}
						<div class="col-md-9">
							{!! Form::text('re_name', $relationship->re_name ,['class'=>'form-control','placeholder'=>trans('admin.re_name')]) !!}
						</div>
					</div>
					<br>
