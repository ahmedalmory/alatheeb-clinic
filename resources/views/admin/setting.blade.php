...
$(document).ready(function() {
	...
	$(add_button).click(function(e){ //on add input button click
		...
		if(x < max_fields){ //max input box allowed
			...
			$(wrapper).append('<div class="" style="display:flex"><input type="text" placeholder="{{ trans('admin.phones') }}" name="phones[]" class="form-control"><a href="#" class="remove_field btn btn-danger"><i class="fa fa-trash"></i></a></div>'); //add input box
		}
	});
			...
			<div class="portlet-body form">
				<div class="col-md-12">
                    ...
                    <div class="form-group">
                        {!! Form::label('tax_enabled',"تفعيل الضريبة",['class'=>'col-md-3 control-label']) !!}
                        <div class="col-md-9">
                    ...
                    <br>
                    <div class="form-group">
                        {!! Form::label('tax_rate',"قيمة الضريبة",['class'=>'col-md-3 control-label']) !!}
                        <div class="col-md-9">
                    ...
                    <br>
                    <div class="form-group">
                        {!! Form::label('tax_id',"الرقم الضريبي",['class'=>'col-md-3 control-label']) !!}
                        <div class="col-md-9">
                    ...
                    <br>
                    <div class="form-group">
                        {!! Form::label('build_num',"رقم المبنى",['class'=>'col-md-3 control-label']) !!}
                        <div class="col-md-9">
                            {!! Form::text('build_num',setting()->build_num,['class'=>'form-control']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        {!! Form::label('unit_num',"رقم الوحدة",['class'=>'col-md-3 control-label']) !!}
                        <div class="col-md-9">
                    ...
                    <br>
                    <div class="form-group">
                        {!! Form::label('postal_code',"الرمز البريدي",['class'=>'col-md-3 control-label']) !!}
                        <div class="col-md-9">
                    ...
                    <br>
                    <div class="form-group">
                        {!! Form::label('extra_number',"الرقم الاضافي",['class'=>'col-md-3 control-label']) !!}
                        <div class="col-md-9">
