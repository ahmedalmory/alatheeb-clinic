...
{!! Form::open(['url'=>aurl('/slides').'/'.$edit->id,'method'=>'put','files'=>true]) !!}
<div class="form-body">
...
<input name="url" type="url" placeholder="{{ trans('admin.url') }}" class="form-control" value="{{ $edit->url }}" placeholder="{{ trans('admin.url') }}">
 ...
 <div class="form-group">
<label>مفعل</label>
<input  name="active" type="hidden"  class="form-control" value="0" >
<input name="active" type="checkbox"  class="form-control" value="1" {{$edit->active ? 'checked': ''}} >
</div>
