                    ...
                    >
                        ...
                        @foreach($patient_files as $file)
                            <tr>
                                ...
                                <td>
                                    <a
                                        href="{{ url('src/images/patient_files/'.$file->image) }}"
                                        target="_blank"
                                        class="btn btn-primary"
                                    ><i class="fa fa-eye"></i
                                        ></a>
                                ...
                                <td>
                                    <button
                                        onclick="printJS({printable:'{{ url('src/images/patient_files/'.$file->image) }}', type:'{{ preg_match('/image/i',$file->mimtype)?'image':'' }}{{ preg_match('/pdf/i',$file->mimtype)?'pdf':'' }}{{ !preg_match('/image|pdf/i',$file->mimtype)?'html':'' }}', showModal:false})"
