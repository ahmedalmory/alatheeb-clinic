<section>
    ...
    <div class="row w-100 mx-0 mt-5 "
        style="display: flex;flex-wrap: wrap; justify-content: center; background-color: #fff; padding: 21px 0px 0; border-radius: 10px;">
        ...
        <div class="col-md-4 col-lg-2 mb-3">
            <div class="index-dd">
                ...
                <span
                    class="badge bg-success-lt mx-2 mt-0">{{\App\Models\Patient::query()->whereDate('created_at',\Carbon\Carbon::today()->toDateTimeString())->count()}}</span>
            </div>
        </div>
        <div class="col-md-4 col-lg-2 mb-3">
            <div class="index-dd">
