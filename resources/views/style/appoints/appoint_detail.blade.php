    ...
    <div class="" style="min-width:800px">
        <table class="table table-bordered">
          ...
          for ($i = $open_time; $i < $close_time; $i += (60 * setting()->patient_exposure)) {
            ...
            <tr>
                <td>
                    <?php echo  $period_time = date("h:i", $i); echo " / ".$appoint_date;?>
                </td>
                <td bgcolor="#FF0000">
                    @php
                    ...
                    echo ("<a href='".url('
                        doctor/patients/'.$getdata->patient_id)."'>".patient_name($getdata->patient_id)."</a>");
                    }
                    @endphp
                ...
                <td>
                  ...
                  ?>
                    <a class="btn btn-success btn-sm" target="_blank"
                        href="https://wa.me/966500876876/?text={{urlencode($message)}}">
