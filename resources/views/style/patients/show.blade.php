@extends('style.index') @section('content') @push('js')
<script
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
            <div class="sidebar">
                <ul>
                    ...
                    >
                        <a href="{{ url()->current() }}?data=facture"
                            >فواتير المريض</a
                        >
                    </li>
                    <li
                    ...
                    >
                        <a href="{{ url()->current() }}?data=appoints"
                            >مواعيد المريض</a
                        >
                    </li>
                    <li
                    ...
                    >
                        <a href="{{ url()->current() }}?data=diagnosis"
                            >تشخيصات</a
                        >
                    </li>
                    <li
                        class="{{ request('data') == 'files' ? 'active' : '' }}"
                    >
        ...
        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
            ...
            @if(request('data') === 'facture')
                <a href="?data=facture" class="btn btn-success  mb-3" style="margin-bottom:10px">الكل <span class="badge badge-default">0</span> </a>
                <a href="?data=facture&status=paid" class="btn btn-info  mb-3" style="margin-bottom:10px">مسددة <span class="badge badge-default">0</span> </a>
                <a href="?data=facture&status=unpaid" class="btn btn-danger  mb-3" style="margin-bottom:10px">غير مسددة <span class="badge badge-default">0</span> </a>
                <table
                    class="table table-condensed table-hover table-bordered table-striped"
                >
                    <thead>
                ...
                >
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th>
                                <a
                                    href="{{ url('diagnosis/'.$diagnos->id.'/edit') }}"
                                    class="btn btn-info btn-sm"
                                    ><i class="fa fa-pencil-square-o"></i>
                                    تعديل</a
                                >
                                <a
                                    href="{{ url('diagnosis/'.$diagnos->id.'') }}"
                    ...
                    >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{\App\User::query()->find($file->user_id)->name ?? "لم يحدد"}}</td>
                                <td>
                                    <a
                                        data-toggle="modal" data-target="#myModal-{{ $file->file_name }}"
                                    ...
                                    ></a>
                                    <a
                                        data-toggle="modal" data-target="#myModaldelete-{{ $file->file_name }}"
                                    ...
                                    <!-- Modal -->
                                    <div class="modal fade" id="myModal-{{ $file->file_name }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                            <h4 class="modal-title d-none" id="myModalLabel">{{ $file->file_name }}</h4>
                                          </div>
                                          <div class="modal-body">
                                            <img style="width:100%" src="{{ url('src/images/patient_files/'.$file->image) }}" alt="">
                                          </div>
                                    ...
                                    <div class="modal fade" id="myModaldelete-{{ $file->file_name }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                ...
                <div class="showuserpage">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                            <span
                                >{{ trans("admin.id") }} :
                                <p>{{$patients->id}}</p></span
                            >
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                            <span
                                >{{ trans("admin.user_id") }} :
                                <p>{{ @$patients->user->name }}</p></span
                            >
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <span
                                >{{ trans("admin.last_update_user_id") }} :
                                <p>
