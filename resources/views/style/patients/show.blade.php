    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
            <div class="tablearea">
                ...
                <a href="?data=facture" class="btn btn-success  mb-3" style="margin-bottom:10px">الكل <span
                        class="badge badge-default">0</span> </a>
                <a href="?data=facture&status=paid" class="btn btn-info  mb-3" style="margin-bottom:10px">مسددة <span
                        class="badge badge-default">0</span> </a>
                <a href="?data=facture&status=unpaid" class="btn btn-danger  mb-3" style="margin-bottom:10px">غير مسددة
                    <span class="badge badge-default">0</span> </a>
                <table class="table table-condensed table-hover table-bordered table-striped">
                    <thead>
                        <tr>
                            <th>رقم الفاتورة</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- Modal -->
                                    <div class="modal fade" id="myModal-{{ $file->file_name }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title d-none" id="myModalLabel">{{ $file->file_name
                                                        }}</h4>
                                                </div>
                                    ...
                                    <div class="modal fade" id="myModaldelete-{{ $file->file_name }}" tabindex="-1"
                                        role="dialog" aria-labelledby="myModalLabel">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
