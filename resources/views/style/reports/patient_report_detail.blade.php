...
<?php } ?>
            <tr>
                <td colspan="4">الاجــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــمالي</td>
<td> <?=$total_amount;?></td>
<td><?=$total_cash;?></td>
<td><?=$total_card;?></td>
<td> <?=$total_due;?></td>
...
<div class="popoverr" id="popoverr">
    ...
    <div id="popoverr_text" class="list print_summary">
        ...
        <table class="np" style="width:100% !important;">
            ...
            <tr><td> اسم المريض :</td><td colspan="2">{{patient_name($pat_id)}}</td><td>.....</td><td> اسم الدكتور :</td><td colspan="2"><?php if($doc_id != -5){ echo doctor_name($doc_id);}?></td><td>.....</td><td> : العيادة</td><td><?php if($dep_id != -5){ echo clinic_name($dep_id);}?></td></tr>
        </table>
